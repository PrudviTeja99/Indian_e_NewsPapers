...
public class RecyclerViewAdapterHindi extends RecyclerView.Adapter<RecyclerViewAdapterHindi.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dataList=list.get(position);
                Intent intent=new Intent(v.getContext(),NewsPaperHindi.class);
