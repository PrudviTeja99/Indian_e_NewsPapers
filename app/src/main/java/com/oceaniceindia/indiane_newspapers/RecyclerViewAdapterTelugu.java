...
public class RecyclerViewAdapterTelugu extends RecyclerView.Adapter<RecyclerViewAdapterTelugu.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(), NewsPaperTelugu.class);
                dataList=list.get(position);
